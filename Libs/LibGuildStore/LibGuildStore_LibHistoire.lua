...
function internal:TestRefresh()
  ...
  task:Call(function() internal:dm("Info", GetString(GS_REFRESH_FINISHED)) end)
  task:Call(function() internal:DatabaseBusy(false) end)
  task:Call(function() ReloadUI() end)
end
