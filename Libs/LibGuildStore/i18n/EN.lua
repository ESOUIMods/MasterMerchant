...
ZO_CreateStringId("GS_INIT_SALES_HISTORY_SUMMARY", "Init Sales and Item totals: %s seconds to init %s records.")
...
ZO_CreateStringId("GS_INIT_POSTED_HISTORY_SUMMARY", "Init Posted Items totals: %s seconds to init %s records.")
ZO_CreateStringId("GS_INIT_CANCELLED_HISTORY_SUMMARY", "Init Cancelled Items totals: %s seconds to init %s records.")
