...
local SortOrderDealPercentSubclass = SortOrderBase:Subclass()
...
function MasterMerchant.SortOrderDealPercent:Initialize()
  SortOrderBase.Initialize(self, DEAL_PERCENT_ORDER, DEAL_PERCENT_ORDER_LABEL, function(a, b)
    ...
    if MasterMerchant.systemSavedVariables.agsPercentSortOrderToUse == MasterMerchant.AGS_PERCENT_ASCENDING then
