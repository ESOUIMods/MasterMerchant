...
ZO_CreateStringId("MM_PTC_SALES_COUNT_TIP", "Include Sales Count with Price To Chat.")
...
ZO_CreateStringId("MM_PTC_DAYS_RANGE_NAME", "Include Days Range")
ZO_CreateStringId("MM_PTC_DAYS_RANGE_TIP", "Include the Days Range with Price To Chat.")
