...
ZO_CreateStringId("MM_PTC_GROUP_BEGIN", "(")
ZO_CreateStringId("MM_PTC_GROUP_END", ")")
ZO_CreateStringId("MM_PTC_SEPERATOR", "/")
...
ZO_CreateStringId("MM_PTC_IS_VERBOSE_NAME", "Verbose Price Description")
ZO_CreateStringId("MM_PTC_IS_VERBOSE_TIP", "Include or exclude words such as sales, listings, and items.")
ZO_CreateStringId("MM_PTC_SALES_COUNT_NAME", "Include Sales Count")
ZO_CreateStringId("MM_PTC_SALES_COUNT_TIP", "Include Sales Count with Price formatting.")
