...
ZO_CreateStringId("GS_RESET_LISTINGS_BUTTON", "Réinitialiser les annonces")
ZO_CreateStringId("GS_RESET_LISTINGS_DESC", "Cela ne réinitialisera que les listes pour le type de serveur actuel NA ou EU.")
ZO_CreateStringId("GS_RESET_LISTINGS_NAME", "Réinitialiser les données des annonces")
ZO_CreateStringId("GS_RESET_LISTINGS_TIP", "Réinitialiser toutes les annonces LibGuildStore.")
ZO_CreateStringId("GS_RESET_LISTINGS_CONFIRM_TITLE", "Confirmer la réinitialisation des annonces")
...
ZO_CreateStringId("GS_IMPORT_MM_NAME", "Importer des données de MM")
...
ZO_CreateStringId("GS_IMPORT_ATT_NAME", "Importer des données de ATT")
...
ZO_CreateStringId("GS_IMPORT_ATT_PURCHASE_NAME", "Importer des achats de ATT")
ZO_CreateStringId("GS_IMPORT_ATT_PURCHASE_TIP", "Importer les données d'achats ATT dans LibGuildStore.")

ZO_CreateStringId("GS_IMPORT_SL_BUTTON", "Importer les données de la liste de courses")
...
ZO_CreateStringId("GS_IMPORT_SL_NAME", "Importer Shoppinglist")
ZO_CreateStringId("GS_IMPORT_SL_TIP", "Importer les données de Shoppinglist dans LibGuildStore.")

ZO_CreateStringId("GS_IMPORT_PD_BUTTON", "Importer des données de tarification")
ZO_CreateStringId("GS_IMPORT_PD_DESC", "Importez les données de tarification MM dans LibGuildStore. Les données de tarification précédentes ne seront disponibles qu'en tant que données de tarificat centrales. Il n'importera pas les mêmes données de tarification dans chaque guilde distincte.")
ZO_CreateStringId("GS_IMPORT_PD_NAME", "Importer des données de tarification")
ZO_CreateStringId("GS_IMPORT_PD_TIP", "Importez les données de tarification dans LibGuildStore. Ne sera disponible que lors de l'utilisation des données de tarification centrales. Pour les guildes individuelles, vous devrez établir de nouvelles données de tarification par guilde.")
...
ZO_CreateStringId("GS_COLOR_PURPLE", "pourpre")
...
ZO_CreateStringId("GS_DAYS_ONLY_NAME", "Utiliser uniquement la taille de l'historique des ventes")
...
ZO_CreateStringId("GS_ALL_BUTTON", "Toute")
ZO_CreateStringId("GS_WEAPONS_BUTTON", "Armes")
ZO_CreateStringId("GS_ARMOR_BUTTON", "Armure")
ZO_CreateStringId("GS_JEWELRY_BUTTON", "Bijoux")
ZO_CreateStringId("GS_CONSUMABLE_BUTTON", "Consommable")
ZO_CreateStringId("GS_CRAFTING_BUTTON", "Matériaux")
ZO_CreateStringId("GS_FURNISHING_BUTTON", "Ameublement")
ZO_CreateStringId("GS_COMPANION_BUTTON", "Compagnon")
ZO_CreateStringId("GS_MISCELLANEOUS_BUTTON", "Divers")
ZO_CreateStringId("GS_UNKNOWN_BUTTON", "Inconnu")
...
ZO_CreateStringId("GS_IMPORT_ATT_SALES", "Importer des ventes de ATT")
ZO_CreateStringId("GS_ATT_MISSING", "Arkadius Trade Tools Données de vente non détectées.")
ZO_CreateStringId("GS_IMPORT_MM_SALES", "Importation des ventes de MasterMerchant")
