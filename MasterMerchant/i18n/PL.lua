...
ZO_CreateStringId("SK_FIRST_SCAN", "There is no data in LibGuildStore. Requesting data from LibHistoire. This can take a few minutes!")
...
ZO_CreateStringId("MM_INITIALIZING", "Master Merchant Inicjowanie...")
ZO_CreateStringId("MM_INITIALIZED", "Master Merchant zainicjowany: potrącenie %s sprzedaż.")
