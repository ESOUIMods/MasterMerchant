...
ZO_CreateStringId("MM_TRAVEL_TO_ZONE_TEXT", "Путешествовать в...")
...
-- New values
ZO_CreateStringId("MM_TIP_FORMAT_SINGLE", "Цена MM (%s продаж, %d предметов, %s День): %s")
ZO_CreateStringId("MM_TIP_FORMAT_MULTI", "Цена MM (%s продаж, %d предметов, %s Дни): %s")
ZO_CreateStringId("MM_BONANZA_TIP", "Bonanza price (%s продаж/%s предметов): %s")
ZO_CreateStringId("MM_TIP_FORMAT_NONE", "Нет данных MM")
ZO_CreateStringId("MM_TIP_FORMAT_NONE_RANGE", "У MM нет данных за прошедшие %d дней")
...
ZO_CreateStringId("MM_STATS_TO_CHAT", "MM Статистика в чат")
